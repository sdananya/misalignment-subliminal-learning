RUN_SPEC = {'name': 'coherence_sweep_coherence_eval_airiskdilemmas',
 ...
 'constitution': {'path': 'data/constitutions/coherence.json', 'num_criteria': 8},
 'dataset': {'path': 'data/scenarios/airiskdilemmas.json', 'count': 100, 'shuffle': True, 'shuffle_seed': 42},
 'collection': {'group_size': 4,
                ...
                'allow_ties': True,
                'enabled': False,
                'evaluations_path': '/home/t-sutradhara/misalignment-subliminal-learning/outputs/eigenbench_runs/coherence_sweep_coherence_eval_airiskdilemmas/evaluations.jsonl'},
 'training': {'enabled': True, 'method': 'btd_d2'},
 'analysis': {'enabled': True, 'metric': 'coherence_score', 'bootstrap_samples': 1000}}
