RUN_SPEC = {'name': 'coherence_sweep_evaluation',
 ...
 'dataset': {'path': '/home/t-sutradhara/misalignment-subliminal-learning/data/scenarios/airiskdilemmas.json',
             'count': 300,
             'shuffle': True,
             'shuffle_seed': 42},
 'collection': {'group_size': 4,
                ...
                'allow_ties': True,
                'enabled': False,
                'evaluations_path': '/home/t-sutradhara/misalignment-subliminal-learning/outputs/eigenbench_runs/coherence_sweep_evaluation_airiskdilemmas/evaluations.jsonl'},
